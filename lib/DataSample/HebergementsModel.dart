...
class HerbergemntMod {
  ...
  HerbergemntMod.fromJson(Map json)
      : id = json['id'],
        ...
        perien = json['perien'],
        imgh = json['imgh'],
        ln = json['ln'] != null ? json['ln'].toDouble() : json['ln'],
        lat = json['lat'] != null ? json['lat'].toDouble() : json['lat'],
        note = json['note'] != null ? json['note'].toDouble() : json['note'],
  ...
  Map toJson() {
    return {
      ...
      'accesen': accesen,
      'accesfr': accesfr,
      'standingfr': standingfr,
      'standingen': standingen,
      'securitefr': securitefr,
      'securiteen': securiteen
    };
  }

  static Map<String, dynamic> toMap(HerbergemntMod herbergement) => {
        'id': herbergement.id,
  ...
  static String encodeHotels(List<HerbergemntMod> hotelhts) => json.encode(
        hotelhts
            .map<Map<String, dynamic>>((hotelht) => toMap(hotelht))
            .toList(),
      );

  static List<HerbergemntMod> decodeHotels(String hotelhts) =>
      (json.decode(hotelhts) as List<dynamic>)
          .map<HerbergemntMod>((item) => HerbergemntMod.fromJson(item))
          .toList();
}
