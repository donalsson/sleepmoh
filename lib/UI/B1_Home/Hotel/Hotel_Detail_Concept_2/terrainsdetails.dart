...
class terrainsdetails extends StatefulWidget {
  ...
  @override
  _terrainsdetailsState createState() => _terrainsdetailsState();
}
 var listImages = initlistImages.map((model) => Imagem.fromJson(model)).toList();
  final oCcy = new NumberFormat("#,##0.00", "en_US");
String currentLocale;
class _terrainsdetailsState extends State<terrainsdetails> {
