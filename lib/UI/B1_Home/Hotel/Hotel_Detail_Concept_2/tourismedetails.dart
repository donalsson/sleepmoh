...
class tourismedetails extends StatefulWidget {
  ...
  @override
  _tourismedetailsState createState() => _tourismedetailsState();
}
...
class _tourismedetailsState extends State<tourismedetails> {
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Row(
            children: <Widget>[
              Text(
                "Nombre de Chambres :        " + widget.acces,
                style: TextStyle(
                    fontFamily: "Sofia",
                    color: Colors.black54,
                    fontSize: 16.0,
          ...
          child: Row(
            children: <Widget>[
              Text(
                "Nombre de Cuisine :        " + widget.stanting,
                style: TextStyle(
                    fontFamily: "Sofia",
                    color: Colors.black54,
                    fontSize: 16.0,
          ...
          child: Row(
            children: <Widget>[
              Text(
                "Nombre de Douche :        " + widget.securi,
                style: TextStyle(
                    fontFamily: "Sofia",
                    color: Colors.black54,
                    fontSize: 16.0,
              ...
              new LinearPercentIndicator(
                ...
                progressColor: int.parse(widget.acces) >= 3 ? Colors.green : int.parse(widget.acces) > 1 && int.parse(widget.acces) < 3 ? Colors.orange : Colors.red,
                animation: true,
                backgroundColor: Color(0xFFDADBDF),
              ),
            ],
