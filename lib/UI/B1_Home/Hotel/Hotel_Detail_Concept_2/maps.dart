...
import 'package:sleepmohapp/DataSample/mapsModelData.dart';
...
Future<void> listMarkersli() async {
  print("listmap");
    final SharedPreferences sharedPrefs = await SharedPreferences.getInstance();
    setState(() {
  Iterable list = jsonDecode(sharedPrefs.get('listHotel1'));
     print(list);
        //SharedPreferencesClass.save("Hotell", response.body);
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: NetworkImage(listHotels[index].imgh),
                          fit: BoxFit.cover)),
                ),
              ),
              Padding(
  ...
  moveCamera() {
    _controller.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(
        target: LatLng(listHotels[_pageController.page.toInt()].lat, listHotels[_pageController.page.toInt()].ln),
        zoom: 14.0,
        bearing: 45.0,
        tilt: 45.0)));
  }
