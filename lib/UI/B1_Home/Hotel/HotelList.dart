...
import 'Hotel_Detail_Concept_1/hotelDetail_concept_1.dart';
                ...
                children: <Widget>[
                  Row(
                    children: <Widget>[
                      ...
                      Padding(
                        padding:
                            EdgeInsets.only(top: 35.0, left: 15.0, right: 15.0),
                        child: InkWell(
                          onTap: () =>
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: Text("Rechercher ce que vous voulez",
                                        style: TextStyle(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Text(hotelData.localisation, style: _txtStyleSub)
                            ],
                          ),
                        )
                      ],
